...
// И ещё одно: в старых версиях гита в консоли bash не показывается событие выхода из консолького ввода по клавишам ctrl+c.
// Если вдруг вы проверяете в консоли bash и у вас не срабатывает событие по клавишам ctrl+c, то проверьте, пожалуйста, то же самое в другой консоли.
// Либо ещё можно обновить гит до последней версии - тоже должно всё заработать. Заранее спасибо!
